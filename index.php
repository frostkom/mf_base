...
add_action('plugins_loaded', array($obj_base, 'plugins_loaded'));
...
function activate_base()
{
	...
	mf_uninstall_plugin(array(
		'options' => array('setting_base_auto_core_update', 'setting_base_auto_core_email', 'option_base_large_table_amount'),
	));
}
...
function uninstall_base()
{
	mf_uninstall_plugin(array(
		'uploads' => 'mf_base',
		'options' => array('setting_base_info', 'setting_base_cron', 'setting_base_update_htaccess', 'setting_base_template_site', 'setting_base_empty_trash_days', 'setting_base_recommend', 'option_cron_started', 'option_cron_run', 'option_sync_sites', 'option_base_ftp_size', 'option_base_db_size', 'option_base_large_tables'),
	));
}